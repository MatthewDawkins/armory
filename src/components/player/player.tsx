...
export const Player: React.FC<PlayerProps> = (props: PlayerProps) => (
  <div className="player">
    {props.items && (
      <div id="player-area" className={`player-area-${props.class.toLowerCase()}`}>
        <div className="player-header">
          ...
          <div className="player-info">
            <h3 key="player-class-01" className={`player-class-${props.class}`}>{`${props.spec} ${props.class}`}</h3>
            <h3 key="player-class-02" className={`player-class-${props.class}`}>{`${props.server}`}</h3>
          </div>
        </div>
        <InventoryWrapper
